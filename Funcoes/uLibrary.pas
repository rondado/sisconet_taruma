...
uses Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
     ...
     IdHashMessageDigest, ACBrValidador, Vcl.Consts;
...
var
  ...
  //procedimento para traduzir menssagens
  ...
  //rondado funcao para verificar se é Numero
...
//rondado implemntacao da funcao para verificar se é numero
function IsNumeric(S : String) : Boolean;
var
  i: integer;
begin
...
//procedimento para traduzir mensagem
// ****************************************************************************
procedure SetResourceString(AResString: PResStringRec; ANewValue: PChar);
// ****************************************************************************
// *  ideal para traduzir mensagens do Delphi.
// * Data de Início.: 26/01/2011
// ****************************************************************************
var
  POldProtect: DWORD;
begin
...
procedure TraduzMensagens();
// *******************************************************************
// * Traduz as principais mensagens do Delphi.
// * Data de Início: 26/01/2011
// ******************************************************************
begin
  ...
  SetResourceString(@SMsgDlgConfirm, 'Confirme');
  SetResourceString(@SYesButton, 'Não');
