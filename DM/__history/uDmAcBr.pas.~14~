...
uses
  ...
  ACBrDFe, ACBrMail, frxClass, ACBrSATExtratoFortes,
  ACBrSATExtratoFortesFr, ACBrSATExtratoClass, ACBrSATExtratoESCPOS,
  ACBrSAT, ACBrPosPrinter, ACBrNFeDANFeESCPOS, ACBrDANFCeFortesFr, ACBrNCMs,
  ACBrNFeDANFEFRDM, ACBrBlocoX, ACBrCTe, ACBrNFSeDANFSeClass, ACBrNFSeDANFSeFR,
  ACBrNFSe, ACBrExtenso, ACBrBoleto, ACBrBoletoFCFortesFr;
