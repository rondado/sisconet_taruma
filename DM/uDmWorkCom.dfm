object DmWorkCom: TDmWorkCom
  ...
  object QryPedidos: TSQLQuery
    ...
    object QryPedidosCNPJ_OPERADORA: TStringField
  ...
  object QryCaixaMov: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'where caixa_mov.data_mov = :pData')
    SQLConnection = DmConexao.ConexaoDBX
    Left = 296
    Top = 224
  ...
  object DspMesasItensAgrupa: TDataSetProvider
    DataSet = QryMesasItensAgrupa
    UpdateMode = upWhereKeyOnly
    OnGetTableName = DspMesasItensGetTableName
    Left = 712
    Top = 504
  end
  object QryMesasItensAgrupa: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 712
    Top = 448
    object QryMesasItensAgrupaID_MESA: TIntegerField
      FieldName = 'ID_MESA'
      Required = True
    end
    object QryMesasItensAgrupaID_PRODUTO: TIntegerField
      FieldName = 'ID_PRODUTO'
      Required = True
    end
    object QryMesasItensAgrupaDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 50
    end
    object QryMesasItensAgrupaQUANT: TFloatField
      FieldName = 'QUANT'
    end
    object QryMesasItensAgrupaPRECO_UNIT: TFloatField
      FieldName = 'PRECO_UNIT'
    end
    object QryMesasItensAgrupaPRECO_TOTAL: TFloatField
      FieldName = 'PRECO_TOTAL'
    end
    object QryMesasItensAgrupaCANCELADO: TStringField
      FieldName = 'CANCELADO'
      FixedChar = True
      Size = 1
    end
  end
  object CdsMesasItensAgrupa: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 712
    Top = 554
    object CdsMesasItensAgrupaID_MESA: TIntegerField
      FieldName = 'ID_MESA'
      Required = True
    end
    object CdsMesasItensAgrupaID_PRODUTO: TIntegerField
      FieldName = 'ID_PRODUTO'
      Required = True
    end
    object CdsMesasItensAgrupaDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 50
    end
    object CdsMesasItensAgrupaQUANT: TFloatField
      FieldName = 'QUANT'
    end
    object CdsMesasItensAgrupaPRECO_UNIT: TFloatField
      FieldName = 'PRECO_UNIT'
    end
    object CdsMesasItensAgrupaPRECO_TOTAL: TFloatField
      FieldName = 'PRECO_TOTAL'
    end
    object CdsMesasItensAgrupaCANCELADO: TStringField
      FieldName = 'CANCELADO'
      FixedChar = True
      Size = 1
    end
