...
type
  TDmProdutos = class(TDataModule)
    ...
    CdsProdutos2FRETE: TFloatField;
    CdsProdutos2CUSTO_OPER: TFloatField;
    CdsProdutos2OUTRAS_DESP: TFloatField;
    CdsProdutos2ALIQ_SSIMPLES: TFloatField;
    CdsProdutos2A_GRANEL: TStringField;
    CdsProdutos2ITEM_A_COMPOR: TStringField;
  ...
  public
    ...
    function Dados_Produto3(fEAN13, pID:String):Boolean;
...
function TDmProdutos.Dados_Produto3(fEAN13 , pID :String): Boolean;
begin
  CdsProdutos.Close;
  QryProdutos.Close;
  ...
  QryProdutos.SQL.Add('where produtos.EAN13 = :pEAN13 and produtos.ID =  ');
  QryProdutos.SQL.Add(pID);
  end
  else begin
  QryProdutos.SQL.Add('select * from produtos');
