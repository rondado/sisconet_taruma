...
uses
  ...
  uFrmAbreRegistra_multiplos in 'uFrmAbreRegistra_multiplos.pas' {FrmAbreRegistra_multiplos},
  uFrmProdutos_multiplos in 'uFrmProdutos_multiplos.pas' {FrmProdutos_Multiplos},
  ...
  uTrocaCaracteresEspeciais in 'Funcoes\uTrocaCaracteresEspeciais.pas',
  LanguageControl in 'Funcoes\LanguageControl.pas',
