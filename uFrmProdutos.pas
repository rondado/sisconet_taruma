...
type
  ...
  public
    { Public declarations }
    sIDProd, registraMesa, xIDCor, xIDTamanho : Integer;
    xNomeCor, xTamanho  : String;
    sPermitirCombustivel, sApenasConsulta, isFood : Boolean;
  end;
...
begin
  ...
  Qryconsulta.SQL.add('and produtos.item_a_compor = '+QuotedStr('N')+')');
  if not sPermitirCombustivel then
     QryConsulta.SQL.Add('and produtos.combustivel = '+QuotedStr('N'));
  if CbxTipoPesq.ItemIndex = 0 then // ID
     QryConsulta.SQL.Add('and produtos.id = :pID  ')
  ...
  //trocar descricao por código na consulta de acordo com o arqVerifica
...
procedure TFrmProdutos.GridDadosDrawColumnCell(Sender: TObject;
