...
uses uLibrary, uDmAcbr, uFrmDadosCobranca, uRelQuita44Col,
  uFrmLeCodigo, uDmWorkCom, uDMClientes, uDmConexao;
...
begin
  ...
  begin
    ...
    if Confirmacao('Confirma a quitação do documento '+CdsContas.FieldByName('NUMCONTA').AsString+'/'+
                                                       ...
                                                       CdsContas.FieldByName('CLIENTE').AsString+'?') then
    begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DmAcbr.ACBrBoleto1.NomeArqRetorno := OpenDialog1.FileName;
...
begin
  ...
  aTexto := 'Recebemos de '+CdsContas.FieldByName('CLIENTE').AsString+', a importância de R$'+
