...
begin       
   ...
   //tipo de documentos fiscal, 0=PAF-ECF, 1=NFCE, 2=SAT, 3=NFRENTE
   sPAFNFCe := 2;
...
begin
  ...
  begin
    ...
    // rondado alteração para ser possível o caixa ficar aberto de um dia para o outro
   ...
   //   MessageDlg('A Data do caixa aberto não conhecide com a data atual do sistema. Verfique!', mtWarning, [mbOK], 0);
    //  Abort;
     ...
     if DataCaixa < SVData then
     begin
         MessageDlg('Assim que possível confira o caixa e realize o fechamento, A DATA ATUAL É DIFERENTE DA DATA DE ABERTURA!', mtWarning, [mbOK], 0);
    //  Abort;
     end;
...
var aValor, NomeOperador, aMotivoSangria : String;
    aValorAux : Double;
    DataCaixa : TDateTime;
begin
  // Abre Jornada Fiscal
  ...
  begin
    ...
    begin
      ...
      //
      aValor := '0';
      if InputQuery('Sangria no Caixa','Valor',aValor) then
      begin
        try
          //rondado motivo da sangria
          InputQuery('Sangria','Informe o MOTIVO:',aMotivoSangria);
        ...
        begin
          ...
          DmWorkCom.CdsCaixaMov.FieldByName('HISTORICO').AsString := 'SANGRIA DE CAIXA' + '- MOTIVO: ' +aMotivoSangria ;
...
var aValor, NomeOperador,aMotivoSuprimento : String;
    aValorAux : Double;
    DataCaixa : TDateTime;
begin
  // Abre Jornada Fiscal
  ...
  begin
    ...
    begin
      ...
      //
      aValor := '0';
      if InputQuery('Suprimento no CAIXA','Valor',aValor) then
      begin
        try
        //rondado motivo do suprimento
          InputQuery('SUPRIMENTO','Informe a ORIGEM:',aMotivoSuprimento);
        ...
        begin
          DmWorkCom.PAFECF.EmiteGerencialSSuprimentoNFCe(DmWorkCom.PAFECF.gCaixa,
                                                         DmWorkCom.PAFECF.gOperador,
                                                         now,aValorAux,aMotivoSuprimento);
        end;
        // grava registro de movimento
        if DmWorkCom.Dados_Caixa(SVData,True) then
        begin
          DmWorkCom.Dados_CaixaMov(0);
          DmWorkCom.CdsCaixaMov.Append;
          DmWorkCom.CdsCaixaMov.FieldByName('HISTORICO').AsString := 'SUPRIMENTO DE CAIXA'+ '- MOTIVO: ' +aMotivoSuprimento ;
          DmWorkCom.CdsCaixaMov.FieldByName('ORIGEM').AsString    := 'MOVIMENTO';
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              DmWorkCom.Dados_CaixaMov(0);
              DmWorkCom.CdsCaixaMov.Append;
              DmWorkCom.CdsCaixaMov.FieldByName('HISTORICO').AsString := 'SANGRIA DE CAIXA - Fechamento';
              DmWorkCom.CdsCaixaMov.FieldByName('ORIGEM').AsString    := 'MOVIMENTO';
              DmWorkCom.CdsCaixaMov.FieldByName('DC').AsString        := 'D';
