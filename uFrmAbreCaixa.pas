...
// rondado alteracao ioperador como caixa
 DataCaixa.DataSet.FieldByName('IDOPERADOR').AsInteger
 := DmWorkCom.PAFECF.gIDOperador; //original
 //DataCaixa.DataSet.FieldByName('IDOPERADOR').AsInteger := 3; // alterado
...
procedure TFrmAbreCaixa.FrameConfirmaCancela1BtnConfirmarClick(
  Sender: TObject);
begin
  inherited;
