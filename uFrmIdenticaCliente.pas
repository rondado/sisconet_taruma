...
begin
  ...
  begin
  // rondado modificao para verificar CPF e CNPJ
   if EdtCPF.Text <> '' then  //inicio do if do CPF
    begin
      ...
      else if Length(FiltraNumero(EdtCPF.Text)) = 14  then
      begin
...
begin
  ...
  if not aEntra then
  begin
    MessageDlg('O Documento informado (CPF ou CNPJ) é inválido. Verifique!!!', mtWarning, [mbOK], 0);
    EdtCPF.SelectAll;
    EdtCPF.SetFocus;
  end;
